...
- `fab-build` complete for the named stage
...
- Test files
- `docs/spec.md`, `docs/blueprint.md` (app-directory copies after `/fab-scaffold`)
- `fabrica.run.json` (required; app-directory copy after `/fab-scaffold`)
...
- `prerequisite_missing`: stage has not been implemented or artifacts/tests are missing → suggest `/fab-build <stage>`.
- `gate_blocked`: quality score below threshold on any axis → set stage blocked and route to `/fab-fix`.
