...
- `external_failure`: error not reproducible, command fails, or fix does not resolve root cause → log context, suggest manual diagnosis, and route to `/fab-decide` if needed.
